...
if(!empty($productoList)){
	$encabezado = ['idProducto', 'Nombre', 'Categoria', 'Proveedor', 'Tipo', 'Estado'];
}
...
foreach ($productoList as $producto){
    $data[] = $producto->getAllParams(false, false);
}
...
<html lang="es">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Listado de Tours | Caribetour Admin</title>
                    ...
                    <div class="page-content">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <h3 class="header smaller lighter blue">Tours</h3>
                                ...
                                <div class="clearfix">
                                    <div class="pull-left tableTools-container">
                                        ...
                                        <a class="dt-button buttons-collection btn btn-white btn-primary btn-bold" id="nuevo" title="nuevo" href="producto-form.php">
                                            <span>
                ...
                */
                ...
                var myDataTable = function(){
                    var myTable = $('#dynamic-table').DataTable( {
                        ...
                        "ajax": {
                            "method": "POST",
                            "url": "json-data-list/producto-lista.php"
                        },
