...
<html lang="es-ES">
    <head>
        ...
        <meta property="og:title" content="Destinos en CaribeTour.es | Especialistas en el Caribe" />
        <meta name="title" content="Destinos en CaribeTour.es | Especialistas en el Caribe" />
        <meta name="DC.title" content="Destinos en CaribeTour.es | Especialistas en el Caribe" />
        <title>Destinos en CaribeTour.es | Especialistas en el Caribe</title>
        <meta name="description" content="Destinos en CaribeTour.es | Especialistas en el Caribe" />
        <meta name="keywords" content="Destinos en CaribeTour.es | Especialistas en el Caribe" />
        <!--[if lt IE 9]>
        ...
        <div class="container site-container">
            ...
            <section class="container site-content">
				...
				<div class="row"><?php $i=1; do { ?>
                        ...
                        <div class="featured-blog">
                            <article class="post-112 post type-post status-publish format-standard hentry category-guides tag-amet tag-dolor tag-lorem post">
                                <div class="featured-image">
                                    <a hreflang="es" type="text/html" charset="iso-8859-1" href="destinos/<?php echo "categoria"; ?>"><img width="440" height="299" src="img/<?php echo "imagen.png"; ?>" class="attachment-normal wp-post-image" alt="<?php echo "categoria"; ?>" title="<?php echo "categoria"; ?>" /></a>
                                </div>
                                <div class="post-content">
                                    <h2 class="post-title">
                                        <a hreflang="es" type="text/html" charset="iso-8859-1" href="destinos/<?php echo "categoria"; ?>" title="<?php echo ucwords("categoria"); ?>"><?php echo "categoria"; ?> desde <?php echo (800.54); ?>&euro;</a>
                                    </h2>
                    ...
                    </div><?php if ($i % 3==0){ echo '<div class="clear"></div>'; }?><?php $i++; } while (false); ?>
                </div>	
			</section>
            <!-- /content -->
            <!-- footer -->
