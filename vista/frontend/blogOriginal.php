                            ...
                            <article class="post-112 post type-post status-publish format-standard hentry category-guides post clearfix">
                                <div class="column fivecol post-featured-image">
                                    <div class="featured-image">
                                        <a hreflang="es" type="text/html" charset="iso-8859-1" href="blog/<?php echo 'seo'; ?>"><img width="440" height="299" src="img/<?php echo 'imagen'; ?>" alt="<?php echo ucwords('nombre'); ?>" title="<?php echo ucwords('nombre'); ?>" /></a>
                                    </div>
                                </div>
                        ...
                        <div class="widget widget-selected-posts">
                            ...
                            <article class="post clearfix">
                                <div class="post-featured-image">
                                    <div class="featured-image">
                                        <a hreflang="es" type="text/html" charset="iso-8859-1" href="blog/<?php echo 'seo'; ?>"><img width="440" height="299" src="img/<?php echo 'imagen'; ?>" class="attachment-normal wp-post-image" alt="<?php echo ucwords('nombre'); ?>" title="<?php echo ucwords('nombre'); ?>" /></a>
                                    </div>
                                </div>
                                <div class="post-content">
                            ...
                            <div class="textwidget">
                                <div class="items-grid"><?php $i=1; do { ?>
                                    <div class="column gallery-item sixcol <?php if ($i % 2==0){ echo 'last'; }?>">
                                        <div class="featured-image">
                                            <a href="img/<?php echo 'imagen'; ?>" class="colorbox " data-group="gallery-111" title="<?php echo ucwords('nombre'); ?>"><img width="440" height="330" src="img/<?php echo 'imagen'; ?>" class="attachment-preview wp-post-image" alt="<?php echo 'nombre'; ?>" /></a>
