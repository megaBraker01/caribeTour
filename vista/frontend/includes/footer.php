                ...
                <div class="row">
                    ...
                    <div class="menu">
                        <ul id="menu-footer-menu" class="menu">
                            ...
                            <li id="menu-item-blog" class="menu-item"><a hreflang="es" type="text/html" charset="iso-8859-1" href="blog" title="Nuestro Blog">BLOG</a></li>
                            <li id="menu-item-galeria" class="menu-item"><a hreflang="es" type="text/html" charset="iso-8859-1" href="galeria" title="Galer&iacute;a de Imagenes">GALERIA</a></li>
                            <li id="menu-item-contactos" class="menu-item"><a hreflang="es" type="text/html" charset="iso-8859-1" href="contactos" title="Contacta con Nosotros">CONTACTOS</a></li>
                        </ul>
                    </div>
                </div>
            </footer>