...
<table width="90%" border="0" cellspacing="3" cellpadding="3" align="center">
  ...
  <tr>
	...
	<strong>Oficina:</strong> Calle Puerto del Pozazal 37 3 7�-5, Madrid 28031 - Espa&ntilde;a<br>
	<strong>Tel:</strong> (+34) 676062155<br>
	<strong>Email:</strong> <a href="mailto:info@caribetour.es">info@caribetour.es</a></p>
	<small>Este mensaje puede contener informaci�n privilegiada y/o personal. Si cree que ha recibido �ste correo por error descarte su contenido e informe al remitente para evitar que en el futuro reciba otro correo como este. Disculpe los inconvenientes.</small></td>
  </tr>
</table>
</body>
</html>';
