                    ...
                    <div class="content-slider main-slider" id="slider" style="position:relative">
                      <ul>
                        ...
                        <div class="featured-image">
                            ...
                            </div><img width="824" height="370" src="img/imagen" class="attachment-large wp-post-image" alt="subcategoria" title="Ver Todos Los destinos de subcategoria"/></a></div>
                        </li>
                      </ul>
                	    ...
                	    <div class="tour-thumb-container">
                	      <div class="tour-thumb">
                	        ...
                	        <div class="tour-caption">
                	          <h5 class="tour-title"><a hreflang="es" type="text/html" charset="iso-8859-1" href="destinos/slugCategoria/slugSubCategoria/slugProducto" title="nombreProducto">nombreProducto</a></h5>
                                <div class="tour-meta">
					      ...
					      </div><?php if ($i % 4==0){ echo '<div class="clear"></div>'; }?>
                	  <?php $i++; } while (false); ?>
                      <div class="clear"></div>
				</div>
			</div>
		...
		<div class="sixcol column">
			...
			<div class="items-grid"><?php $x=1; do { ?>
				<div class="column gallery-item fourcol <?php if ($x % 3==0){ echo 'last'; }?>">
					...
					<div class="block-background"></div>
				</div><?php if ($x % 3==0){ echo '<div class="clear"></div>'; }?><?php $x++; } while (false); ?>
				<div class="clear"></div>
			</div>
		</div>
